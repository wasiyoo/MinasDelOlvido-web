...
/** @type {string} */
const CACHE_VERSION = 'icons-20260714114825';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["index.html","index.js","index.offline.html","index.icon.png","index.apple-touch-icon.png","favicon.ico","favicon-16x16.png","favicon-32x32.png","favicon-48x48.png","apple-touch-icon.png","icon-192x192.png","icon-512x512.png","index.audio.worklet.js","index.audio.position.worklet.js","index.manifest.json","splash-minas.png"];
