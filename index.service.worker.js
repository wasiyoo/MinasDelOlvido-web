...
/** @type {string} */
const CACHE_VERSION = 'pwa-install-20260716c';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["index.html","index.js","index.offline.html","index.icon.png","index.apple-touch-icon.png","index.audio.worklet.js","index.audio.position.worklet.js","index.manifest.json","index.192x192.png","index.512x512.png","index.apple-touch-icon.png"];
